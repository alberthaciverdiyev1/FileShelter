        ...
        data.forEach(file => {
            ...
            <div class="aspect-w-1 aspect-h-1 rounded-lg bg-gray-200 text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-white group">
              <div class="relative overflow-hidden bg-cover bg-no-repeat h-full">
                  <a href="/documents/uploads/${file.originalPath}"  data-fancybox="gallery" data-lg-size="1920-1080">
                       <img class="rounded-lg h-full w-full object-cover" src="/documents/thumbnails/${file.thumbnailPath}" alt="${file.filename}" />
